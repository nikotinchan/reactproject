              ...
              <div className="card">
                ...
                <div className="actions">
                  <div className="follow-info">
                    <h2><a href="#"><span>12</span><small>Постов</small></a></h2>
                    <h2><a href="#"><span>1000</span><small>Подписчиков</small></a></h2>
                  </div>
                  <div className="follow-btn">
                    <button onClick={e => {setModalActive(true); setUserid(e.currentTarget.getAttribute('data-id'))}} data-id = {user.id}>Смотреть посты</button>
                  </div>
                </div>
                <div className="desc">Почта: {user.email}</div>
              </div>
          )
        })
      }
